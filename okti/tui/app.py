...
from okti.tui.slash_commands import SlashCommandHandler
...
class ChatPane(VerticalScroll):
    ...
    def compose(self) -> ComposeResult:
        from okti.tui.animations import AnimatedAsciiBanner
    ...
    def show_thinking(self, model_name: str) -> None:
        ...
        from okti.tui.animations import ThinkingIndicator
        self.hide_thinking()
...
class ToolDock(Static):
    ...
    def __init__(self, **kwargs: Any):
        super().__init__(**kwargs)
        self._spinner_idx = 0
        from okti.tui.animations import Speedometer
...
class OktiApp(App):
    ...
    def __init__(
        self,
        config: OktiConfig | None = None,
        resume_session_id: str | None = None,
        force_setup: bool = False,
    ):
        super().__init__()
        self.config = config or OktiConfig()
    ...
    async def on_mount(self) -> None:
        ...
        from okti.tui.onboarding import OnboardingScreen, check_needs_onboarding
    ...
    def _on_onboarding_completed(self, updated_config: OktiConfig | None) -> None:
