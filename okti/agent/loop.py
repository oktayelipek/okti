...
class AgentLoop:
    ...
    def _build_default_registry(self) -> ToolRegistry:
        ...
        from okti.tools.git_tools import register_git_tools
        from okti.tools.plugin import load_all_plugins
        from okti.tools.web import register_web_tools
        ...
        load_all_plugins(
            ...
            trusted_hashes=plugins_cfg.trusted_hashes,
            allow_untrusted=plugins_cfg.allow_untrusted,
        )
    ...
    async def _init_mcp(self) -> None:
        ...
        try:
            from okti.tools.mcp_client import MCPClient, load_mcp_config
